...
import com.github.yoojia.inputs.ValuesPattern;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 必选，数字，最大20字符
        inputs.add(form.findEditText(R.id.form_field_3), StaticPattern.Required(), StaticPattern.Digits(), ValuesPattern.MaxLength(20));
        // 必选，邮件
        inputs.add(form.findEditText(R.id.form_field_4), StaticPattern.Required(), StaticPattern.Email());
        // 必选，与邮件相同
        inputs.add(form.findEditText(R.id.form_field_5), ValuesPattern.Required(), ValuesPattern.EqualsTo(loader.findEditText(R.id.form_field_4)));
        // Host
        ...
        // MaxLength
        inputs.add(form.findEditText(R.id.form_field_7), ValuesPattern.MaxLength(5));
        // MinLength
        inputs.add(form.findEditText(R.id.form_field_8), ValuesPattern.MinLength(4));
        // RangeLength
        inputs.add(form.findEditText(R.id.form_field_9), ValuesPattern.RangeLength(4, 8));
        // Not Blank
        ...
        // MaxValue
        inputs.add(form.findEditText(R.id.form_field_12), ValuesPattern.MaxValue(100));
        // MinValue
        inputs.add(form.findEditText(R.id.form_field_13), ValuesPattern.MinValue(20));
        // RangeValue
        inputs.add(form.findEditText(R.id.form_field_14), ValuesPattern.RangeValue(18, 30));
